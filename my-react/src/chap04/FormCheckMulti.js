    ...
    return (
        <form>
            <fieldset>
                ...
                <input id='animal_hamster' name="animal" type='checkbox' value="hamster" checked={form.animal.includes('hamster')} onChange={handleFormMulti}/><br />
                <label htmlFor='animal_rabbit'>ウサギ</label>
                <input id='animal_rabbit' name="animal" type='checkbox' value="rabbit" checked={form.animal.includes('rabbot')} onChange={handleFormMulti}/><br />
            </fieldset>
